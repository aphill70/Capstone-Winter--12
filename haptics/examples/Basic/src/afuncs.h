...
EXT var	F(pixel_to_bmap)(BMAP*,var,var,var);
EXT var	F(pixel_for_vec)(COLOR*,var,var);
EXT var	F(pixel_to_vec)(COLOR*,var*,var,var);
...
// collision detection
EXT var F(c_content)(VECTOR*);
EXT var F(c_trace)(VECTOR*,VECTOR*,var);
EXT var F(c_move)(ENTITY*,VECTOR*,VECTOR*,var);
EXT var F(c_rotate)(ENTITY*,VECTOR*,var);
EXT var F(c_setminmax)(ENTITY*);
EXT var F(c_updatehull)(ENTITY*,var);
EXT var F(content)(VECTOR*);
EXT var F(trace)(VECTOR*,VECTOR*);
EXT var F(scan_entity)(VECTOR*,VECTOR*);
EXT var F(scan_path)(VECTOR*,VECTOR*);
...
EXT var F(file_chr_read)(var,STRING*);
EXT var F(file_str_read)(var,STRING*);
EXT var F(file_str_write)(var handle,char*);
EXT var F(file_var_read)(var handle);
EXT var F(file_var_write)(var,var);
...
EXT var F(draw_line)(VECTOR*,VECTOR*,var);
...
// misc
EXT var F(exec)(STRING*,STRING*);
EXT var F(execute)(STRING*);
EXT var F(proc_kill)(var);
EXT void* F(ptr_for_name)(char* name);
...
EXT var F(add_buffer)(char* name,void* buffer);	
// add a named buffer for media files

EXT var F(add_folder)(char* pathname);		
// add a path for media files

EXT var F(add_resource)(char* filename);	
// add a WRS resource

EXT var F(add_struct)(void* data,long size);	
// add a memory area to be saved resource
...
// returns - 0 if the line does not contain a valid instruction, nonzero otherwise
...
EXT ENGINE_VARS* engine_open(char* commandline,DWORD mode = 0);	
